	...
	final class Give {
		...
		private function includes() {
			...
			if ( is_admin() || ( defined( 'WP_CLI' ) && WP_CLI ) ) {
				...
				require_once GIVE_PLUGIN_DIR . 'includes/admin/dashboard/dashboard-widgets.php';
				require_once GIVE_PLUGIN_DIR . 'includes/admin/dashboard/class-give-dashboard-widget-extend-feed.php';
